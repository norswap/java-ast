 ...
 * component).
 */
public final class SimpleIdentifierChain implements IdentifierChain
{
    // ---------------------------------------------------------------------------------------------
    ...
    public SimpleIdentifierChain (Identifier... identifiers)
    {
    ...
    @Override public boolean equals (Object o)
    {
        ...
        if (!(o instanceof SimpleIdentifierChain)) return false;
        SimpleIdentifierChain that = (SimpleIdentifierChain) o;
